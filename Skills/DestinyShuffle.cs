      ...
      for (int swapIndex = 0; swapIndex < 3; ++swapIndex) {
        switch (random.Next(1, 4)) {
          case 1:
            ...
            Console.WriteLine($"Обмен HP: {caster.Name} и {target.Name} поменялись здоровьем.\n");
            break;
          ...
          case 2:
            ...
            Console.WriteLine($"Обмен MP на HP: {caster.Name} поменял MP на HP {target.Name}, {target.Name} поменял HP на MP {caster.Name}.\n");
            break;
          ...
          case 3:
            ...
            Console.WriteLine($"Обмен Damage и CritChance: {caster.Name} поменял Damage на CritChance {target.Name}, {target.Name} поменял CritChance на Damage {caster.Name}.\n");
            break;
        }
      }
    }
