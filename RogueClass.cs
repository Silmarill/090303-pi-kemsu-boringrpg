...
namespace BoringRPG {
  internal class RogueClass : Archetype, ICanUseSkill {
    ...
    public static RogueClass operator +(RogueClass rogue, GoldApple apple) {
      ...
      Console.WriteLine($"\n{rogue.Name} съел золотое яблоко! +{apple.Value} +{apple.Value * 3}\n");
      return rogue;
    }
